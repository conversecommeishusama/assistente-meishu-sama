...
EXECUTOR_QUEUE = sys.argv[1] if len(sys.argv) > 1 else "reports/zenshu_periodicos_novos_artigos_revisao/EXECUTOR_QUEUE.json"
AUDITOR_QUEUE = sys.argv[2] if len(sys.argv) > 2 else "reports/zenshu_periodicos_novos_artigos_revisao/AUDITORIA_QUEUE.json"
