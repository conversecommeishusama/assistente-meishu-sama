"""Segunda leitura independente (DeepSeek) de todos os 523 trechos
alterados pela pilha C (143 mesa + 213 + 221 + os 4 casos aprofundados
manualmente) -- confere se o texto final aplicado é fiel ao japonês do
artigo, lendo do zero, sem ver a nota/razão que motivou a correção
original.

    python3 scripts/verifica_trechos_alterados_deepseek.py
    python3 scripts/verifica_trechos_alterados_deepseek.py --relatorio
"""
...
FONTE = Path("/tmp/claude-0/-var-www-goshinsho/9b3b11e7-4883-4ae9-9b3b-2fbf84182cdd/scratchpad/trechos_alterados.json")
DEST = R / "VERIFICACAO_DEEPSEEK_TRECHOS.json"
