...
· Glossário: A entrada de glossário fixa a tradução do termo NO SENTIDO DOUTRINÁRIO em que foi decidida. A mesma palavra pode aparecer em sentido comum -- 曇り como sombra num exame de raio-X e não a mácula do corpo espiritual, 理 como princípio e não «Caminho Perfeito» (que é 道理), 教修 como palestra e não o curso de preparação. Nesses casos aplicar a forma fixa É O ERRO, e a correção que a remove procede. Só é improcedente propor mudar a forma canônica dentro do sentido em que ela foi decidida.
