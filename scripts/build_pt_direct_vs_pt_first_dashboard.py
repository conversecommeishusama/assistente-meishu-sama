...
DATA = json.loads((PROJECT_ROOT / "reports" / "resultado_pt_direct_vs_pt_first.json").read_text(encoding="utf-8"))
OUT = PROJECT_ROOT / "reports" / "dashboard_pt_direct_vs_pt_first.html"
